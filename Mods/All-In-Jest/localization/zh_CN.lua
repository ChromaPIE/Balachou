return {
    misc = {
        dictionary = {
            ...
            aij_no_copy_neg = "复制负片扑克牌",
            aij_no_copy_neg_tooltip = {
                '复制{C:dark_edition}负片{C:attention}扑克牌{}会保留其版本',
            ...
            k_aij_polychrome_ex = '炫彩！', -- Colour Test
        ...
        v_text = {
            ...
            ch_c_aij_sharpest_tool_1 = {
                '{C:attention}商店{}及{C:attention}丑角包{}中',
            },
    ...
    descriptions = {
        ...
        Joker = {
            ...
            j_aij_little_devil = {
                ...
                text = {
                    "{C:attention}跳过盲注{}后",
                    "生成一个{C:attention}标准{}，{C:tarot}魔符{}，",
                    "{C:planet}流星{}，{C:spectral}空灵{}或{C:red}丑角{C:attention}标签"
                },
            },
            j_aij_pierrot = {
                name = "皮埃罗",
            ...
            j_aij_greasepaint = {
                ...
                text = {
                    {
                        "使相邻{C:attention}小丑牌{}失效"
                    },
                    {
                        "失效的{C:attention}小丑牌",
                        "和{C:attention}扑克牌{}给予{X:mult,C:white}X#1#{}倍率"
                    }
                }
            },
            ...
            j_aij_columbina = {
                name = "科伦比娜",
                text = {
                    "{C:aij_plasma}均分{C:chips}筹码{}和{C:mult}倍率{}的{C:attention}#1#%",
            ...
            j_aij_cosmological_constant = {
                name = "宇宙学常数",
                text = {
                    "{C:aij_plasma}均分{}所出{C:attention}牌型{}的",
            ...
            j_aij_arlecchino = {
                name = "喜剧仆角",
                text = {
                    "{C:attention}丑角包{}和{C:attention}标准包",
                    "的可选数量不设上限"
                }
            },
            ...
            j_aij_beanstalk = {
                name = "豆茎",
                text = {
                    "{C:attention}J{C:attention}永不{C:red}失效",
                    "且{C:attention}强制{}计分"
                }
            },
            ...
            j_aij_aluzinnu = {
                name = "阿鲁齐努",
                text = {
                    "{C:attention}象形文字{}和{C:attention}远古岩画{}奖券",
            ...
            j_aij_jester_zombie = {
                name = "小丑僵尸",
                text = {
                    "本回合内若有{C:attention}扑克牌{}被{C:red}摧毁",
            ...
            j_aij_bartender = {
                ...
                text = {
                    "{C:attention}消耗牌{}可能为",
                    "{C:dark_edition}闪箔{}，{C:dark_edition}全息{}或{C:dark_edition}炫彩"
                }
            },
            j_aij_mahoney = {
                name = "马奥尼",
                ...
                text = {
                    {
                        ...
                        "{C:dark_edition}闪箔{}，{C:dark_edition}全息{}或{C:dark_edition}炫彩{}版本"
                    },
                    {
                        "触发时无条件{C:money}-$#3#"
                    },
            ...
            j_aij_biancolelli = {
                ...
                text = {
                    "小丑牌触发后",
                    "{C:aij_plasma}均分{C:chips}筹码{}和{C:mult}倍率"
                },
                unlock = {
                    "?????"
                }
        ...
        Tag = {
            ...
            tag_aij_nonstandard = {
                name = '非标准标签',
                text = {
                    '{C:attention}自定义{}一张{C:attention}扑克牌',
                    '并将其2张复制加入牌组',
                }
            },
            tag_aij_ignoramus = {
