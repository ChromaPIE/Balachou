return {
	descriptions = {
		Back = {
			b_cry_antimatter = {
				name = "反物质牌组",
				text = {
					"拥有{C:attention}几乎所有{}牌组的{C:legendary,E:1}正面效果"
				},
				unlock = {
					"以{C:attention}空白牌组",
					"赢下{C:attention}金注",
			...
			b_cry_antimatter_balanced = {
				name = "反物质牌组",
				text = {
					"拥有{C:attention}几乎所有{}已赢下{C:gold}金注{}的",
					"牌组的{C:legendary,E:1}正面效果"
				},
				unlock = {
					"以{C:attention}空白牌组",
					"赢下{C:attention}金注",
			...
			b_cry_antimatter_custom = {
				name = "反物质牌组",
				text = {
					"拥有{C:attention}部分{}牌组的{C:legendary,E:1}正面效果"
				},
				unlock = {
					"以{C:attention}空白牌组",
					"赢下{C:attention}金注",
			...
			b_cry_beige = {
				...
				unlock = {
					"发现收藏中",
					"至少{C:attention}200{}个项目"
				},
			},
			b_cry_beta = {
				name = "怀旧牌组",
				text = {
					"{C:attention}小丑牌{}和{C:attention}消耗牌{}槽位{C:attention}合而为一",
					"{C:attention}怀旧{}盲注 replace their updated Blind",
				},
				unlock = {
					"赢下{C:attention}粉注",
				},
			...
			b_cry_blank = {
				name = "空白牌组",
				text = {
					"{C:inactive,E:1}啥用也没有……吗？",
				},
			},
			b_cry_bountiful = {
				name = "丰厚牌组",
				text = {
					"{C:blue}出牌{}或{C:red}弃牌后",
					"恒抽取{C:attention}5{}张牌"
				},
				unlock = {
					"不弃牌击败{C:attention}蛇"
				},
		...
		Code = {
			...
			c_cry_exploit = {
				name = "://EXPLOIT",
				text = {
					"{C:inactive,s:0.8}-- 漏洞利用",
					"{C:cry_code}选择{}一种{C:cry_code}已揭示{}牌型",
					"并使下次出牌视为该牌型{C:cry_code}计算",
					"且临时获得{C:cry_code}1{}层{C:cry_code}飞升力",
				},
			},
			c_cry_malware = {
				name = "://MALWARE",
			...
			c_cry_log = {
				...
				text = {
					"{C:inactive,s:0.8}-- 日志",
					"显示下列任一项的{C:cry_code}读取数据{}：",
					"{C:attention}下个{}底注的{C:attention}Boss盲注{}和{C:attention}奖券",
					"商店内的下{C:attention}5{}张{C:attention}小丑牌",
					"即将{C:attention}抽取{}的下{C:attention}10{}张扑克牌",
					"{C:inactive}（若在盲注中）",
				},
			},
			c_cry_quantify = {
			...
			c_cry_delete = {
				...
				text = {
					"{C:inactive,s:0.8}-- 删除",
					'{C:cry_code}驱逐{}一件{C:cry_code}选定{}商品',
					'{C:inactive,s:0.8}本赛局内不会再次',
					'{C:inactive,s:0.8}以常规方式出现'
				},
			},
			c_cry_alttab = {
				name = "://ALTTAB",
		...
		Edition = {
			...
			e_cry_blur = {
				name = "模糊",
				text = {
					"{C:attention}重新触发{}本牌{C:attention}1{}次",
					"有{C:green}#1#/#2#{}的几率",
					"再额外触发{C:attention}#3#{}次"
				},
			},
			e_cry_double_sided = {
				name = "双面",
		...
		Other = {
			...
			asc_misc = {
				...
				text = {
					"{C:gold}#1#{}层飞升力",
					"{C:chips}筹码{}及{C:mult}倍率{X:gold,C:white}X#2#",
			...
			cry_multiuse = {
				name = "m",
				text = {
					"{C:inactive}多次使用：剩余{C:cry_code}#1#{C:inactive}次",
				},
			},
			cry_banned_card = {
				name = "驱逐",
	...
	misc = {
		tutorial = {
			cry_intro_1 = {
				"你好，我叫{C:attention}揪瑟夫·J·揪可儿",
				"欢迎来到{C:cry_exotic,E:1}Cryptid{}！",
			},
			cry_intro_2 = {
				"看来你是头一回在这个存档里玩{C:cry_exotic,E:1}Cryptid",
				"来，带你看看这模组是怎么个事儿！",
			},
			cry_intro_3 = {
				"*长出双手*",
			...
			cry_intro_4 = {
				"一两句话就说明白是不可能的，",
				"我只能说，选择{C:cry_exotic,E:1}Cryptid{}，",
				"就等于选择了{C:cry_exotic,E:1}奔放{}和{C:cry_exotic,E:1}狂野{}！",
				"{C:attention}玩玩小丑，打打扑克{}的日子，就要结束了……",
			},
			cry_intro_5 = {
				"你可能已经从{C:cry_ascendant}游戏方案{}里看出来了，",
				"我钟爱{C:attention}M{}这个字母。",
				"等你选好一种游戏方案，我再继续往下说…….",
				"{s:0.8}注意：游戏方案的平衡工作目前仍极不完善。",
				"{s:0.8}请做好内容频繁变更的准备！",
			},
			cry_modest_1 = {
				"想要接近原版的游戏体验？",
				"这里有专为你准备的{C:cry_ascendant}朴实无华{}方案！",
			},
			cry_modest_2 = {
				"但话虽如此，Cryptid风味的“小巧思”，该有还得有。",
				"下回合会冒出点儿什么来，你绝对捉摸不透……",
			},
			cry_mainline_1 = {
				"想要{E:1,C:attention}打破常规{}？",
				"好消息：{C:cry_ascendant}主流玩法{}方案将助你一臂之力。",
				"用力恰到好处，不至于让你走火入魔！",
			},
			cry_mainline_2 = {
				"这种方案癫归癫，但你仍然有机会感受{C:cry_ascendant}循序渐进{}的乐趣",
				"所以还是得打起精神，做好准备。",
			},
			cry_mainline_3 = {
				"因为在你通往数字飞涨的道路上，",
				"有我安排的一些{E:1,C:dark_edition}Boss{}，",
				"可能会让你后悔在这个{C:cry_ascendant}方案{}下，点击确认……",
			},
			cry_madness_1 = {
				"准备好让你的硬盘{C:red,E:1}灰飞烟灭{}了？",
				"哇哦，好有意思哦！在{C:cry_ascendant}彻底疯狂{}方案面前，",
				"平衡？{E:1,C:red}算个屁！",
			},
			cry_madness_2 = {
				"想当初我左手{C:green}激浪{}，右手鼠标，熬了好几个星期的大夜，",
				"就为了达成这个方案的{C:cry_ascendant}完  美  平  衡{}。",
				"只为了屏幕前的你！"
			},
			cry_madness_3 = {
				"一开局，所有东西完全解锁，",
				"只待你尽情释放Cryptid的{C:red,E:1}究极神力{}！",
				"你唯一需要担心的，只有别把游戏{C:attention,E:1}崩{}了。",
				"比起崩溃，还是“游戏结束”好一点吧……",
			},
		},
		poker_hands = {
		...
		dictionary = {
			...
			cry_gameset_disabled = "禁用",
			cry_gameset_modest = "朴实无华",
			cry_gameset_mainline = "主流玩法",
			cry_gameset_madness = "彻底疯狂",
			cry_gameset_custom = "修改版",
			cry_gameset_Custom = "自定义",
			cry_gameset_exp = "实验性",
			cry_gameset_exp_modest = "实验性（朴实无华）",
			cry_gameset_exp_mainline = "实验性（主流玩法）",
			cry_gameset_exp_madness = "实验性（彻底疯狂）",
