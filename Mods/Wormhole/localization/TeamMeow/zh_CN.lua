return {
						...
						text = {
							{
								...
								"按住并{C:attention}拖拽，即可将{C:worm_meow_spacetart}©太空挞{}喂给{C:attention}小丑牌{}！"
							},
							{
								...
								"{C:attention}小丑牌{}吃掉{C:worm_meow_spacetart}©太空挞{}后会获得对应{C:attention}包装{}，至多可叠加{C:attention}#1#{}层。",
								"{C:attention}包装{}会给予小丑牌{C:attention}不同的额外效果{}！",
							},
							{
								...
								"可将{C:attention}套有包装的小丑牌{}拖拽至另一张小丑牌",
								"以{C:attention}转移最上层的包装{}！",
							},
							{
		...
		Other = {
			...
			worm_meow_spacetart_stacks = {
				text = {
					...
					"{C:inactive,s:0.8}（叠加层数：{C:attention,s:0.8}#1#{C:inactive,s:0.8}）",
				},
			},
			...
			p_worm_spacetart_booster_1 = {
				...
				text = {
					"从至多{C:attention}#2#{}片",
					"包装{C:worm_meow_spacetart}©太空挞{}中",
					"选择{C:attention}#1#{}片"
				},
			},
	...
	misc = {
		dictionary = {
			k_worm_meow_zodicat = "十二宫猫咪",
			b_worm_meow_zodicat_cards = "十二宫猫咪卡",
			k_worm_meow_spacetart = "太空挞",
		...
		labels = {
			worm_meow_zodicat = "十二宫猫咪",
			worm_meow_spacetart = "太空挞",
		},
		achievement_names = {
