return {
  descriptions = {
      ...
      sat_worm_galileo = {
        ...
        text = {
          ...
          },
          {
            "若出牌牌型为{C:attention}#2#",
            "有{C:green}#4#/#5#{}的几率",
            "将完整牌组中{C:attention}#1#{}张牌的花色",
            "转换为{C:attention}#2#{}出牌中占多数的花色",
          }
        }
      },
      sat_worm_sputnik_1 = {
    ...
    Joker = {
      ...
      j_worm_jr_crash_course = {
        name = "促成撞击",
        text = {
          "打出所持{C:planet}星球{}牌的对应牌型后",
          "摧毁该{C:planet}星球{}牌",
          "并生成相应的{C:worm_jr_satellite}人造卫星{}牌",
        }
      },
    },
    Other = {
  ...
  misc = {
    dictionary = {
      -- Standard badge text
      k_worm_jr_satellite = "人造卫星",
      -- For Death Egg and Manhole
      k_worm_jr_satellite_fake = "人造卫星……？",
