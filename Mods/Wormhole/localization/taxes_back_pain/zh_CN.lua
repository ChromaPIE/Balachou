local other_loc_table = {
    misc = {
        ...
        dictionary = {
            b_tbp_module_cards = "飞船模块",
            k_tbp_spaceship = "宇宙飞船",
            k_tbp_module = "飞船模块",
            k_worm_tbp_module = "飞船模块包",
            tbp_module_weapons = '武器',
            tbp_module_core = '核心',
            tbp_module_thrusters = '推进器',
            tbp_module_utility = '实用装备',
            tbp_undisc_module = '未发现的飞船模块',
            tbp_module_equip = '装备',
            tbp_module_store = '暂存',
            tbp_new_module = '新模块',
...
local descriptions = {
    ...
    tbp_module = {
        ...
        dellinger = {
            ...
            text = {
                '打出{C:attention}#2#{}后',
                '使其他{C:tbp_module}模块{}的耐久度提升{C:attention}#1#',
        ...
        quantum = {
            name = '量子计算机',
            text = {
                '有其他{C:green}几率{}结算成功时',
                '获得{C:money}$#1#',
                '{s:0.8,C:inactive}（触发时，有{s:0.8,C:green}#2#/#3#{s:0.8,C:inactive}的几率消耗耐久度）'
            }
        },
        interference = {
