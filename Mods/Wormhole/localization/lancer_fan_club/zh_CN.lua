    ...
    descriptions = {
        ...
        Joker = {
            ...
            j_worm_lfc_pissstream = {
                ...
                text = {
                    "实时获取国际空间站的",
                    "{C:chips}淡水{}、{C:mult}粪便{}及{C:money}尿液{}罐储量数据",
                    "各储罐的{C:attention}满载百分比{}每有1",
                    "本牌相应获得{C:chips}+#1#{}筹码、",
                    " {C:mult}+#2#{}倍率及{C:money}+$#3#{}（向上取整）",
                    "{C:inactive}（当前为{C:chips}+#4#{C:inactive}筹码，{C:mult}+#5#{C:inactive}倍率，{C:money}+$#6#{C:inactive}）"
                }
            },
            j_worm_lfc_log = {
                name =
