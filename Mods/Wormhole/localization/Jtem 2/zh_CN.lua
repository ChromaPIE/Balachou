return {
	descriptions = {
		...
		Joker = {
			...
			j_worm_jtem2_eclipse = {
				...
				text = {
					{
						"引发{C:attention,E:worm_jtem2_snaking}日食{}或{C:attention,E:worm_jtem2_snaking}月食{}：",
						"使用{C:tarot}太阳{}、{C:tarot}月亮{}、{C:planet}地球{}以引发{C:red}日{}食",
						"使用{C:tarot}太阳{}、{C:planet}地球{}、{C:tarot}月亮{}以引发{C:blue}月{}食",
						"{C:inactive}（当前为{V:1}#1#{C:inactive}，必须依序使用）",
					},
					{
						"在{C:red}日{}食期间{X:mult,C:white,s:0.9}使用{C:attention}此牌：",
						"剩余{C:attention}奇数{}次{C:red}弃牌{}：将{C:attention}所有手牌{}变为{C:hearts}红桃",
						"剩余{C:attention}偶数{}次{C:red}弃牌{}：将{C:attention}所有手牌{}变为{C:diamonds}方片",
					},
					{
						"在{C:blue}月{}食期间{X:mult,C:white,s:0.9}使用{C:attention}此牌：",
						"剩余{C:attention}奇数{}次{C:blue}出牌{}：将{C:attention}所有手牌{}变为{C:clubs}梅花",
						"剩余{C:attention}偶数{}次{C:blue}出牌{}：将{C:attention}所有手牌{}变为{C:spades}黑桃",
					},
				},
			},
		...
		Enhanced = {
			...
			m_worm_jtem2_neutron_card = {
				...
				text = {
					"{C:attention}计分{}时",
					"若得分着火，{X:mult,C:white}X#1#{}倍率",
					"否则，使得分{X:purple,C:white}X#2#",
				},
			},
		},
		Tarot = {
		...
		Other = {
			...
			worm_jtem2_black_hole_seal = {
				...
				text = {
					...
					"有{C:green}#3#/#4#{}的几率{C:attention}自毁"
				},
			},
		...
		Spectral = {
			c_worm_jtem2_kilonovae = {
				...
				text = {
					...
					"为至多{C:attention}#1#{}张选定卡牌打上{C:attention}黑洞蜡封",
					"若已有，则打上{C:spectral}超大质量黑洞蜡封",
				},
			},
		},
		PotatoPatch = {
	...
	misc = {
		...
		labels = {
			...
			worm_jtem2_supermassive_black_hole_seal = "超大质量黑洞蜡封",
		},
