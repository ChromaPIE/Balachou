...
return {
    descriptions = {
        ...
        worm_hedonia_menu = {
            ...
            c_worm_hedonia_blackHoleBomb = {
                name = '深水黑洞炸弹',
                text = {
                    '使{C:attention}随机{C:attention}#1#{}张手牌{C:dark_edition}醉倒'
                }
            },
        ...
        Edition = {
            ...
            e_worm_hedonia_blackout = {
                ...
                text = {
                    ...
                    '计分后有{C:green}#3#/#4#{}的几率{C:red,E:2}自毁'
                },
                label = '醉倒'
            },
        },
    ...
    misc = {
        dictionary = {
            b_worm_hedonia_menu_cards = "今晚菜单",
            k_worm_hedonia_menu = "餐品",
            k_worm_hedonia_menu_plus = "餐品+1",
            hedonia_menu = "今晚菜单",
            k_lucky = "Lucky",
        },
        labels = {
            ...
            worm_hedonia_very_drunk = '烂醉',
            worm_hedonia_blackout = '醉倒'
        },
    },
}
