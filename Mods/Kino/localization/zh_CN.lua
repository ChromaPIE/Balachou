    ...
    descriptions = {
        Joker = {
            ...
            j_kino_10_things_i_hate_about_you = {
                ...
                text = {
                    {
                        "若出牌包含{C:attention}爱情片牌{}，耗尽{C:attention}蓄能",
                        "每消耗一{C:attention}层{}，给予{C:chips}+#2#{}筹码和{C:mult}+#1#{}倍率",
                    },
                    {
